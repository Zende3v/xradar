...
export const config = {
  ...
  // Signalisation v2: roads and deduplicated oriented signs in PostGIS (schema "signs", built
  // weekly by signalisation/rebuild.sh). The NDJSON dataset below stays as the fallback while
  // the database is unreachable; SIGNS_SOURCE=dataset forces it.
  signsSource: process.env.SIGNS_SOURCE || 'postgis',
